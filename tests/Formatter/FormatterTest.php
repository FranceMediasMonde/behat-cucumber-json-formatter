...
namespace FranceMediasMonde\BehatCucumberJsonFormatter\Tests\Formatter;
...
class FormatterTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @var \PHPUnit_Framework_MockObject_MockObject
     */
    protected $afterExerciseTestedEvent;

    /**
     * @var \PHPUnit_Framework_MockObject_MockObject
     */
    protected $afterSuiteTestedEvent;
     ...
     * @test
     */
    public function onAfterExerciseTested()
    {
        $this->formatter->setCurrentScenario($this->scenario);
