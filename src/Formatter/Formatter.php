...
use FranceMediasMonde\BehatCucumberJsonFormatter\Renderer\JsonRenderer;
use FranceMediasMonde\BehatCucumberJsonFormatter\Node;
use FranceMediasMonde\BehatCucumberJsonFormatter\Renderer\RendererInterface;
use FranceMediasMonde\BehatCucumberJsonFormatter\Printer\FileOutputPrinter;
...
class Formatter implements FormatterInterface
{
     ...
     *
     * @param TestworkEvent\AfterExerciseCompleted|TestworkEvent\AfterExerciseAborted $event
     */
    ...
    /**
     * @param TestworkEvent\AfterSuiteTested|TestworkEvent\AfterSuiteAborted $event
     */
